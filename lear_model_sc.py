...
forecast_file_name = str(dataset) + str(years_test) + \
                     '_LEAR' + str(calibration_window) + '.csv'
...
## Filename
file_name = f"LEAR_Forecast_run_{years_test}_{current_datetime.strftime('%Y-%m-%d_%H-%M-%S')}.csv"
