...
forecast_file_name = 'DNN_' + str(nlayers) + '_layers' + str(dataset) + \
...
_dnn_hyperopt.hyperparameter_optimizer(path_datasets_folder=path_datasets_folder,
                                       ...
                                       shuffle_train=1,data_augmentation=0,experiment_id=1,
...
error_df.to_csv(os.path.join(path_recalibration_folder, f'DNN_Error_run_{years_test}_{nlayers}_{current_datetime.strftime('%Y-%m-%d_%H-%M-%S')}.csv'))